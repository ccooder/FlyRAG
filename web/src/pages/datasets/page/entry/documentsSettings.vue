 ...
 * @Date: 2025-03-24 15:15:22
 * @LastEditTime: 2025-03-24 17:02:08
 * @LastEditors: WuFeng <763467339@qq.com>
 * @Description: 
 * @FilePath: \FlyRAG\web\src\pages\datasets\page\entry\documentsSettings.vue
 * Copyright 版权声明
-->
<template>
  <div class="pageWrap">
...
const formData = ref({
  target_id: props.docId, // 目标ID，文档或知识库
  type: 2, // 1: 知识库 2: 文档
